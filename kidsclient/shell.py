...
"""
Command-line interface to KIDS API.
"""
...
class KidsShell(object):
    ...
    def get_subcommand_parser(self,version):
        ...
        submodule=utils.import_versioned_module(version,'sheel')
    ...
    def _find_actions(self,subparsers,action_module):
